...
The Muro core team is proud to announce that it has released its 15.1
version, nicknamed "Ascending Albatross", of the open source Muro
firewall software.

This is the first release by the Muro project.  Download `[1] <http://opnsense.org/download/>`__  and try it now!
...
available for all.  Muro uses the simple 2-clause BSD license.
...
Muro(r) is based on FreeBSD 10 and is a fork of pfSense(r) which in its
...
We are looking forward to welcome you in the Muro community.
...
Logjam vulnerability as well as the images for Muro on top of OpenSSL.
...
.. code-block::
    ...
    # SHA256 (Muro-15.1.11.1_OpenSSL-cdrom-amd64.iso.bz2) = 280f02a2da3ff9e9ad1f655a8661c845765493f36e1788b8c852af9886c50316
    # SHA256 (Muro-15.1.11.1_OpenSSL-nano-amd64.img.bz2) = 2d14d881311ca8b188a41a2d57aee6e0bec66f55066f2844502d4ef17e64935e
    # SHA256 (Muro-15.1.11.1_OpenSSL-serial-amd64.img.bz2) = e6e3c8c425dfebc33df9d66cc013616898963c72c52df6e0bed388126c2143a1
    # SHA256 (Muro-15.1.11.1_OpenSSL-vga-amd64.img.bz2) = 64de0201f37cf75c3ba5084f06a1f545eb0a9c4e8248354b584a024322edf488
    # SHA256 (Muro-15.1.11.1_OpenSSL-cdrom-i386.iso.bz2) = 18f1b40981d243173c524af208f8c4cf10a46d41f676d350baba477f07c2ff9e
    # SHA256 (Muro-15.1.11.1_OpenSSL-nano-i386.img.bz2) = 2160335ab904fb0f82dc2629ea7c9116c36059928860169bb9eeac87038db5c7
    # SHA256 (Muro-15.1.11.1_OpenSSL-serial-i386.img.bz2) = a2f7ce128a1ea3ab4942e7ff5accb2901110324d73c516b7bd1a7947b70697cf
    # SHA256 (Muro-15.1.11.1_OpenSSL-vga-i386.img.bz2) = df112aca62de658518bc3f904336fb9024daf404741880e9bb7b93912a5b2af3

.. code-block::

    # MD5 (Muro-15.1.11.1_OpenSSL-cdrom-amd64.iso.bz2) = edc4349b7f3b815302724e60c7ddc0cb
    # MD5 (Muro-15.1.11.1_OpenSSL-nano-amd64.img.bz2) = 1f2cca409ba7e1ab91d6e937627ac275
    # MD5 (Muro-15.1.11.1_OpenSSL-serial-amd64.img.bz2) = 3dcb482fa561fb46748d18fb07048553
    # MD5 (Muro-15.1.11.1_OpenSSL-vga-amd64.img.bz2) = e56074166925c14b586dfff68c8d4494
    # MD5 (Muro-15.1.11.1_OpenSSL-cdrom-i386.iso.bz2) = 3b1904072a4ea48aad6a70cde451cade
    # MD5 (Muro-15.1.11.1_OpenSSL-nano-i386.img.bz2) = a040f331af20a5025d5cbcea1e57d348
    # MD5 (Muro-15.1.11.1_OpenSSL-serial-i386.img.bz2) = 0a8f26ff6fab41c699ba03a9805ec6b5
    # MD5 (Muro-15.1.11.1_OpenSSL-vga-i386.img.bz2) = cf7b4e86a0a856499ca843524d0824bc
...
We are happy to announce Muro 15.1.10.2 today following a rather
...
Last but not least HardenedBSD's work `[2] <https://hardenedbsd.org/article/shawn-webb/2015-05-08/hardenedbsd-teams-opnsense>`__  to build Muro on top of their
...
* development: stable translation template file is available now `[5] <https://raw.githubusercontent.com/opnsense/core/master/src/share/locale/en_US/LC_MESSAGES/Muro.pot>`__ 
...
extensive kernel cleanups to bring Muro closer to FreeBSD, we decided
...
.. code-block::
    ...
    # SHA256 (Muro-15.1.9-cdrom-amd64.iso.bz2) = d159a791cbc373435f25c74f433cc6b419fd8d6df8940d854fec6cd07545acd4
    # SHA256 (Muro-15.1.9-serial-amd64.img.bz2) = 0584fa5092c40af9f8523be527408af57eac2ca71c9522e8167f7ae7f08e0586
    # SHA256 (Muro-15.1.9-vga-amd64.img.bz2) = ccd550b471aa6b13d9a8921aa9461d5eddedaeb9c375e97261ff4e54ebd881d2
    # SHA256 (Muro-15.1.9-cdrom-i386.iso.bz2) = dd3816e0b9c166009de0bde47adce28472bcc639918de91813db4b0ad3bd863e
    # SHA256 (Muro-15.1.9-serial-i386.img.bz2) = 6b39d3a3ede80f6996c589eeeb39b0777b3ae878f79101b85f9b7af3dad771d3
    # SHA256 (Muro-15.1.9-vga-i386.img.bz2) = 56b401719811d233cfd476f49501c436e0f3f02422a1bbc711aa70c0a1a4e340

.. code-block::

    # MD5 (Muro-15.1.9-cdrom-amd64.iso.bz2) = 82b9575e8070248d52b01baae9d31544
    # MD5 (Muro-15.1.9-serial-amd64.img.bz2) = 3f516cfb088d13f747bc68a0725b955d
    # MD5 (Muro-15.1.9-vga-amd64.img.bz2) = 14f035f45c89f5fd404881baac93528f
    # MD5 (Muro-15.1.9-cdrom-i386.iso.bz2) = 09e724a1313f5ebbbfcbf61c62e0803d
    # MD5 (Muro-15.1.9-serial-i386.img.bz2) = 736069fb503de87599b0f866a47fdb02
    # MD5 (Muro-15.1.9-vga-i386.img.bz2) = c79f0c9fe2a0fcb4d8f4ff18146fe340
...
* src: Muro branding for boot loader
...
.. code-block::
    ...
    # SHA256 (Muro-15.1.8-cdrom-amd64.iso.bz2) = c8cb295cd711f880e6406ab8d84c84a31cdc678c40e4d3be4c3fe9546614bdcc
    # SHA256 (Muro-15.1.8-serial-amd64.img.bz2) = 1d51a7d229a145eb92517211a96d9c9bcb0e3585c21931406463368349129997
    # SHA256 (Muro-15.1.8-vga-amd64.img.bz2) = 9a9777af215e66dfa4032d2052f320234c32809816094c1a58d2ebe5c81bdd1a
    # SHA256 (Muro-15.1.8-cdrom-i386.iso.bz2) = e1d1b11ac23a043ab0bdff2a923a8a920814f72e79b852f39e66f185963f8cc4
    # SHA256 (Muro-15.1.8-serial-i386.img.bz2) = fe078471b8409a2102f216252db4f59580853a0182c33d39d4b2c676a1f9e3b7
    # SHA256 (Muro-15.1.8-vga-i386.img.bz2) = df7ca44649f7283df774acddc2df7e06961d80033e959cde01ebce664bf6f488

.. code-block::

    # MD5 (Muro-15.1.8-cdrom-amd64.iso.bz2) = 79eff753cdb749dacb9e106a1781ce64
    # MD5 (Muro-15.1.8-serial-amd64.img.bz2) = 8e643edf6d6cee72535bd8913cf4176e
    # MD5 (Muro-15.1.8-vga-amd64.img.bz2) = c20fee3989a786e12ba0ec3f0e565660
    # MD5 (Muro-15.1.8-cdrom-i386.iso.bz2) = 8b8459017333d654c8b1a7f246a4e250
    # MD5 (Muro-15.1.8-serial-i386.img.bz2) = 6f2e9656a02f32cebf18c9b31b5439f2
    # MD5 (Muro-15.1.8-vga-i386.img.bz2) = 4cbbebe46142d1e954c76383340f61e6
...
If you are new to Muro, the 15.1.7 images can be found here and are easily
...
At this point, using any of the two methods, you should be on Muro
...
First of all we are grateful for the successful launch of Muro.  Thank
...
you are invited to do so.  Let's make Muro the best open source firewall
together.

To fix some bugs we release the Muro version 15.1.1 as an intermediate
