...
base remains. As it stands today, Muro has evolved from being a fork to a whole new
...
----------------------------------
With Muro, we have restored a stable project with clear goals and a very simple
...
* Muro is now a package that can be installed on top of our custom FreeBSD
...
You are invited! Try Muro, be part of the community and help the project move
forward. Muro is rapidly becoming the number one open source firewall platform!
