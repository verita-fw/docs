# -*- coding: utf-8 -*-
#
# Muro documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'Muro.tex', u'Muro Documentation',
     u'Deciso B.V.', 'manual'),
]
...
man_pages = [
    (master_doc, 'opnsense', u'Muro Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Muro', u'',
     author, 'Muro', 'High-end security made easy.',
     'Miscellaneous'),
]
