...
.. Note::
    ...
    The default configured settings in Muro for proper serial connectivity in
...
Starting from Muro 22.1 (22.4 for the business edition) and the change to FreeBSD 13-STABLE, support for EFI
