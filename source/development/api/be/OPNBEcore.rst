...
.. code-block:: python
    ...
    r = requests.get(
        'https://127.0.0.1/api/opncentral/sync/read_config/Muro.Firewall.Alias',
...
When executed, this will dump the contents of the configuration path :code:`Muro.Firewall.Alias` into a named array
