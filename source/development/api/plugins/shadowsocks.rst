...
.. csv-table:: Service (GeneralController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `General.xml <https://github.com/opnsense/plugins/blob/master/net/shadowsocks/src/opnsense/mvc/app/models/Muro/Shadowsocks/General.xml>`__"
...
.. csv-table:: Service (LocalController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Local.xml <https://github.com/opnsense/plugins/blob/master/net/shadowsocks/src/opnsense/mvc/app/models/Muro/Shadowsocks/Local.xml>`__"
