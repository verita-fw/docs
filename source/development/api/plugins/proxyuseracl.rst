...
.. csv-table:: Resources (SettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `ProxyUserACL.xml <https://github.com/opnsense/plugins/blob/master/www/web-proxy-useracl/src/opnsense/mvc/app/models/Muro/ProxyUserACL/ProxyUserACL.xml>`__"
