...
.. csv-table:: Service (ServiceController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `ZabbixAgent.xml <https://github.com/opnsense/plugins/blob/master/net-mgmt/zabbix-agent/src/opnsense/mvc/app/models/Muro/ZabbixAgent/ZabbixAgent.xml>`__"
