...
.. csv-table:: Service (SimplifiedSettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `HelloWorld.xml <https://github.com/opnsense/plugins/blob/master/devel/helloworld/src/opnsense/mvc/app/models/Muro/HelloWorld/HelloWorld.xml>`__"
