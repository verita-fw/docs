...
.. csv-table:: Resources (LaggSettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Lagg.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/Interfaces/Lagg.xml>`__"
...
.. csv-table:: Resources (LoopbackSettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Loopback.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/Interfaces/Loopback.xml>`__"
...
.. csv-table:: Resources (VipSettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Vip.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/Interfaces/Vip.xml>`__"
...
.. csv-table:: Resources (VlanSettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Vlan.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/Interfaces/Vlan.xml>`__"
...
.. csv-table:: Resources (VxlanSettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `VxLan.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/Interfaces/VxLan.xml>`__"
