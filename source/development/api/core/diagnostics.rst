...
.. csv-table:: Service (DnsDiagnosticsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `DnsDiagnostics.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/Diagnostics/DnsDiagnostics.xml>`__"
...
.. csv-table:: Resources (LvtemplateController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Lvtemplate.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/Diagnostics/Lvtemplate.xml>`__"
...
.. csv-table:: Resources (PacketCaptureController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `PacketCapture.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/Diagnostics/PacketCapture.xml>`__"
...
.. csv-table:: Service (PingController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Ping.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/Diagnostics/Ping.xml>`__"
...
.. csv-table:: Service (PortprobeController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Portprobe.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/Diagnostics/Portprobe.xml>`__"
...
.. csv-table:: Service (TracerouteController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Traceroute.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/Diagnostics/Traceroute.xml>`__"
