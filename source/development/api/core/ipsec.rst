...
.. csv-table:: Resources (ConnectionsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Swanctl.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/IPsec/Swanctl.xml>`__"
...
.. csv-table:: Resources (KeyPairsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `IPsec.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Muro/IPsec/IPsec.xml>`__"
