...
For all Muro modules and applications there are some basic style and
...
When creating modules for Muro, always name your components like
this: VendorName/ModuleName

In our sample case this will be: Muro/HelloWorld
...
models/Muro/HelloWorld directory.
...
.. code-block:: php
    :caption: /usr/local/opnsense/mvc/app/models/Muro/HelloWorld/HelloWorld.php

    <?php
    namespace Muro\HelloWorld;
     
...
.. code-block:: xml
    :caption: /usr/local/opnsense/mvc/app/models/Muro/HelloWorld/HelloWorld.xml

    <model>
        <mount>//Muro/helloworld</mount>
        <description>
            the Muro "Hello World" application
        </description>
        <items>
        </items>
    </model>
...
Create a template named index.volt inside the views/Muro/HelloWorld
directory containing the following data:


.. code-block:: html
    :caption: /usr/local/opnsense/mvc/app/views/Muro/HelloWorld/index.volt
...
Every Muro module should separate presentation from logic, that’s
...
in controllers/Muro/HelloWorld/ with the following name
IndexController.php and contents:

.. code-block:: php
    :caption: /usr/local/opnsense/mvc/app/controllers/Muro/HelloWorld/IndexController.php

    <?php
    namespace Muro\HelloWorld;
    class IndexController extends \Muro\Base\IndexController
    {
        public function indexAction()
        {
            // pick the template to serve to our users.
            $this->view->pick('Muro/HelloWorld/index');
        }
    }
...
.. code-block:: php
    :caption: /usr/local/opnsense/mvc/app/controllers/Muro/HelloWorld/Api/SettingsController.php

    <?php
    namespace Muro\HelloWorld\Api;
     
...
models/Muro/Base/FieldTypes directory. If specific field types
...
.. code-block:: xml
    :caption: /usr/local/opnsense/mvc/app/controllers/Muro/HelloWorld/forms/general.xml
...
.. code-block:: php
    ...
    use \Muro\HelloWorld\HelloWorld;
...
.. code-block:: php
    ...
    class SimplifiedSettingsController extends ApiMutableModelControllerBase
    {
        ...
        protected static $internalModelClass = 'Muro\HelloWorld\HelloWorld';
    }
...
and save our form, by using the Muro libraries you can validate your
data automatically.
...
::
    ...
    /usr/local/opnsense/service/templates/Muro/HelloWorld/
...
.. code-block:: html+jinja
    :caption: /usr/local/opnsense/service/templates/Muro/HelloWorld/helloworld.conf
...
controllers/Muro/HelloWorld/Api/ServiceController.php and add the
...
.. code-block:: php
    ...
    public function reloadAction()
    {
        ...
        if ($this->request->isPost()) {
            $backend = new Backend();
            $bckresult = trim($backend->configdRun("template reload Muro/HelloWorld"));
            if ($bckresult == "OK") {
                $status = "ok";
            }
        }
...
::
  ...
  configctl template reload Muro/HelloWorld
...
::
    ...
    [test]
    command:/usr/local/opnsense/scripts/Muro/HelloWorld/testConnection.py
    parameters:
    type:script_output
...
Muro is available in may different languages like english, german or japanese.
...
.. Note::
    ...
    This makes plugins hard to translate and will decrease the quality of Muro in other languages.
...
.. code-block:: xml
    :caption: /usr/local/opnsense/mvc/app/models/Muro/HelloWorld/Menu/Menu.xml
...
.. code-block:: xml
    :caption: /usr/local/opnsense/mvc/app/models/Muro/HelloWorld/ACL/ACL.xml
...
All files are created in their original locations (on the Muro
...
::
    ...
    src/opnsense/mvc/app/controllers/Muro/HelloWorld/Api/ServiceController.php
    src/opnsense/mvc/app/controllers/Muro/HelloWorld/Api/SettingsController.php
    src/opnsense/mvc/app/controllers/Muro/HelloWorld/Api/SimplifiedSettingsController.php
    src/opnsense/mvc/app/controllers/Muro/HelloWorld/IndexController.php
    src/opnsense/mvc/app/controllers/Muro/HelloWorld/forms/general.xml
    src/opnsense/mvc/app/models/Muro/HelloWorld/ACL/ACL.xml
    src/opnsense/mvc/app/models/Muro/HelloWorld/HelloWorld.php
    src/opnsense/mvc/app/models/Muro/HelloWorld/HelloWorld.xml
    src/opnsense/mvc/app/models/Muro/HelloWorld/Menu/Menu.xml
    src/opnsense/mvc/app/views/Muro/HelloWorld/index.volt
    src/opnsense/scripts/Muro/HelloWorld/testConnection.py
    src/opnsense/service/templates/Muro/HelloWorld/+TARGETS
    src/opnsense/service/templates/Muro/HelloWorld/helloworld.conf
...
will be a standard pkg package, which you can install on any Muro
...
-  Muro architecture :doc:`Architecture <../architecture>`
-  Muro creating models
