...
The purpose of this example is to show how to build data grids in Muro, using the various components
...
.. code-block:: php
    :linenos:
    :caption: /usr/local/opnsense/mvc/app/models/Muro/GridExample/GridExample.php

    <?php
    namespace Muro\GridExample;
...
.. code-block:: xml
    ...
    :linenos:
    :caption: /usr/local/opnsense/mvc/app/models/Muro/GridExample/GridExample.xml

    <model>
        <mount>//Muro/GridExample</mount>
        <description>
            the Muro "GridExample" application
        </description>
        <items>
            <addresses>
...
the preinstalled types can be found in our field type directory on `GitHub <https://github.com/opnsense/core/tree/master/src/opnsense/mvc/app/models/Muro/Base/FieldTypes>`__.
...
.. code-block:: php
    :linenos:
    :caption: /usr/local/opnsense/mvc/app/controllers/Muro/GridExample/Api/SettingsController.php

    namespace Muro\GridExample\Api;
    ...
    class SettingsController extends ApiMutableModelControllerBase
    {
        ...
        protected static $internalModelClass = 'Muro\GridExample\GridExample';
...
.. code-block:: xml
    :caption: /usr/local/opnsense/mvc/app/controllers/Muro/GridExample/forms/dialogAddress.xml
...
.. code-block:: html
    :caption: /usr/local/opnsense/mvc/app/views/Muro/GridExample/index.volt
    :linenos:
...
.. code-block:: php
    :linenos:
    :caption: /usr/local/opnsense/mvc/app/controllers/Muro/GridExample/IndexController.php
    ...
    class IndexController extends \Muro\Base\IndexController
    {
        ...
        {
            $this->view->pick('Muro/GridExample/index');
