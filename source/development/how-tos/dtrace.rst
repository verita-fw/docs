...
Since Muro runs on a fork of FreeBSD, DTrace is natively available on the 
...
We will be looking at setting up DTrace on Muro, and running a sample script 
...
this document provides an explanation in combination with the use of Muro-specific tools. 
...
Make sure the Muro/src repository is present on the system and navigate to 
...
Make sure the Muro-tools repository is installed and navigate to :code:`/usr/tools/config/[VERSION]`. 
