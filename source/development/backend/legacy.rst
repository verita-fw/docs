...
::
    ...
    function myplugin_firewall(\Muro\Firewall\Plugin $fw) {
...
.. Note::
    ...
    As of Muro 19.7 Syslog-NG is included in our base system, these files will only be used to identify applications
...
.. Note::
    ...
    The readme on `GitHub <https://github.com/opnsense/core/blob/master/src/opnsense/service/templates/Muro/Syslog/local/README>`__
...
.. Note::
    ...
    In case additional source sockets should be used by Syslog-NG you can add files in :code:`/usr/local/opnsense/service/templates/Muro/Syslog/sources/`
    containing definitions.
    The `001-local.conf <https://github.com/opnsense/core/blob/22.1.7/src/opnsense/service/templates/Muro/Syslog/sources/001-local.conf#L5>`__ file
...
A simple example to expose the configuration section Myplugin within the Muro xml path looks like this:
