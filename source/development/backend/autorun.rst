...
Muro offers an easy method to plug in custom scripts during boot stages and assorted system events.
...
Part of the bootup process of Muro is probing the available rc(8) configuration files in */etc/rc.conf.d/*, when a daemon is enabled, the system will call the regular rc(8) start command.
