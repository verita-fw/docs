...
Muro comes with a collection of standard field types, which can be used to perform standard field type validations.
These field types can be found in `/usr/local/opnsense/mvc/app/models/Muro/Base/FieldTypes/ <https://github.com/opnsense/core/tree/master/src/opnsense/mvc/app/models/Muro/Base/FieldTypes>`__
...
.. code-block:: xml
    ...
    <pipe type="ModelRelationField">
        <Model>
            <pipes>
                <source>Muro.TrafficShaper.TrafficShaper</source>
