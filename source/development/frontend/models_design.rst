...
Creating models for Muro is divided into two separate blocks:

#. A PHP class describing the actions on our data (also acts as a
   wrapper to our data),
#. The definition of the data and the rules it should apply to.

Every model's class should be derived from Muro\\Base\\BaseModel, a very
...
their own namespace at *Muro\\Base\\FieldTypes* deriving from *BaseField*.
