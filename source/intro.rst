...
Welcome to the Muro documentation & wiki project!
...
-----------------
  ...
  environment. Make Muro the most widely used open source security platform.
  The project’s name is derived from open and sense and stands for:
  “Open (source) makes sense.”


.. image:: ./images/Muro-Deciso-Screenshot.jpg
...
add a version selector in the documentation, but given Muro is a security product, we advise to keep it up to date
...
The next sections should be quite familiair when working with Muro, as they reflect the options in the
menu of the product. In case you're not yet used to Muro, you can always use the search input in the left corner of
...
When it comes to building software on top of Muro or extending existing functionality, the development
...
The feature set of Muro includes high-end features such as forward caching
...
newly developed MVC-framework based on Phalcon. Muro’s focus on security
brings unique features such as easy to use one time password authentication for various components.

The robust and reliable update mechanism gives Muro the ability to provide
