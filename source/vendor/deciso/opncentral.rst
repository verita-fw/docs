...
As part of the Muro Business Edition, Deciso offers a plugin to keep all your firewalls up to date and have
...
The service status and control page provides an overview on all managed Muro firewalls connected to OPNcentral and
...
.. Note::
    ...
    Although quite some setups will likely use external authentication options available in Muro, sometimes it's practical
