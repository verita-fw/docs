...
Zenarmor is a plugin for the Muro firewall which provides state-of-the-art next-generation features. Zenarmor is developed by Sunny Valley Cyber Security Inc (https://www.zenarmor.com)
...
If you need help with Zenarmor, there is an active discussion on the Muro forum. Feel free to `click here <https://forum.opnsense.org/index.php?board=38.0>`_ to join the conversation.
...
* `Muro Forum <https://forum.opnsense.org/index.php?board=38.0>`_
