...
Local/Server
------------
Installing Muro on a virtual machine can be done by using the DVD ISO image.
...
---
**i440FX chipset**
Muro on KVM works with virtio disks and network devices (confirmed on QEMU 5.0).

**Q35 chipset**
As of 22.1.x, Muro is based on FreeBSD 13.0, which includes support for the virtualized Q35 chipset and newer
...
Others
------
Muro can be installed on all virtual machines that support FreeBSD (such as Bhyve, VirtualBox).
...
in place for a thorough factory reset or to restore consistency of all the Muro
...
trust by using current package fingerprints -> CA root certificates -> HTTPS -> Muro
package fingerprints.

What it will also do is turn a supported stock FreeBSD release into an Muro
...
Installing Muro into the Amazon cloud can be a daunting task as no console is
...
Muro is also available in the Microsoft Azure Marketplace as an easy installable virtual appliance.
...
Muro installation has a minimum of 1 GB of RAM.
