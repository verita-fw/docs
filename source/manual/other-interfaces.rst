...
(where both networks are connected to your Muro device) to reach it via this bridge. Note that this does not
...
although this will need additional software such as IGMP-proxy or PIMD, which are less commonly used on Muro.
