...
The IDS/IPS available in Muro is based on Suricata.
This open source IDS/IPS engine has proven its value in Muro, especially in combination with the free Proofpoint ETOpen ruleset.

The need for valuable threat detection data and the increasing importance of additional network security
has brought Proofpoint and Muro together.
...
When you allow your Muro system to share anonymized information about detected threats - the alerts -
...
.. Note::
    ...
    When ET Pro Telemetry is activated, your Muro system sends data to Proofpoint. Proofpoint does not know who you are, they
...
.. Note::
    ...
    To use ET Pro Telemetry, you will need to have Muro 19.1 or higher installed. When using an older version,
...
Next step is to register your token in Muro and enable rulesets.
