...
The Intrusion Prevention System (IPS) system of Muro is based on Suricata_
...
Muro includes a very polished solution to block protected sites based on
...
Muro supports custom Suricata configurations in `suricata.yaml <https://suricata.readthedocs.io/en/suricata-6.0.0/configuration/suricata-yaml.html>`__
format. In order to add custom options, create a template file named :code:`custom.yaml` in the :code:`/usr/local/opnsense/service/templates/Muro/IDS/` directory.
...
Muro has integrated support for ETOpen rules.
...
Muro version 18.1.7 introduced the URLHaus List from abuse.ch which collects
...
Muro 18.1.11 introduced the app detection ruleset. Since about 80
