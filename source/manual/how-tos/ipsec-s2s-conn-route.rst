...
This example utilises the new options available in Muro 23.1 to setup a site to site tunnel in routed mode
between two Muro machines using a pre shared key.
