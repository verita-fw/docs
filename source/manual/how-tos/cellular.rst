...
===========================
Muro supports a wide range of USB and miniPCIe cellular modems that can be used
...
In general, Muro should support all cellular modems that are supported by the
...
.. Note::
  ...
  configuring the modem in Muro. There is little chance that you
...
consult the Muro support forum.
