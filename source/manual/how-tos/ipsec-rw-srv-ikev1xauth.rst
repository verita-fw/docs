===========================================
IPsec: Setup Muro for IKEv1 using XAuth
===========================================

.. contents:: Index

XAuth was an addition to IKEv1 supporting user authentication credentials additionally to
pre-shared keys or certificates. There are three different types supported by Muro which
...
========================== ======================= ========================================
  **Description**           IPsec Muro          *Freely chosen description*
...
========================== ======================= =============================
  **Name**                  IPsec Muro         *Freely chosen name*
  **Type**                  IPSec Xauth PSK        *As configured in Muro*
