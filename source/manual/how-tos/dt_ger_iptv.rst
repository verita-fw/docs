...
All network hardware between Muro and the Media Receiver or TV Box must support IGMP snooping. Without IGMP snooping enabled, the network
...
Ensure you are running Muro 22.1 or later
