...
working Muro installation wit a unique LAN IP subnet for each side of your
...
**Remote gateway**         4.3.2.1       *The public IP address of your remote Muro*
...
**Internet Protocol**      IPv4
**Interface**              WAN           *Choose the interface connected to the internet*
**Remote gateway**         1.2.3.4       *The public IP address of your remote Muro*
