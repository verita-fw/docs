...
One of the options with Muro's traffic shaper is its ability to add shaping
  ...
  :caption: Simple network diagram
    ...
    nwdiag {
      ...
      network WAN  {
        ...
        fw1 [label="Muro", shape = "cisco.firewall", address="172.10.1.1/32"];
      }
      ...
      network LAN {
        ...
        fw1 [label="Muro",address="192.168.1.1/24"];
      }
      ...
      network GuestNet {
        ...
        fw1 [label="Muro",address="192.168.2.1/24"];
      }
