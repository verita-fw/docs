...
**Remote gateway**         172.10.2.1    *the public IP address of your remote Muro*
...
**Internet Protocol**      IPv4
**Interface**              WAN           *choose the interface connected to the internet*
**Remote gateway**         172.10.1.1    *the public IP address of your remote Muro*
...
--------------------
For test purposes we used two Muro boxes integrated into one unit and a
...
Configuration Site A
    :download:`Config.xml Site A <resources/config-Muro-ipsec-Site-A.xml>`

Configuration Site B
    :download:`Config.xml Site B <resources/config-Muro-ipsec-Site-B.xml>`
