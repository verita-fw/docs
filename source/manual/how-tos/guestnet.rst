...
either buy or obtain for free at the reception. Muro has built-in support for
...
Prerequisites
-------------
We will start configuration with a fresh Muro install, updated to the latest
...
------------------------
The template feature is one of the most powerful features of Muro's Captive
...
Logout. For this feature we will use Muro's built-in API calls.
...
-----------------------------
Muro has a very powerful CLI that is particularly useful for debugging purposes.
