...
The Muro WAF uses NAXSI_, which is a loadable module for the nginx_ web server.
...
* Muro blocks User Agents used by Bots automatically - this cannot be configured
...
you should get a message in the server error log as well as an Muro
