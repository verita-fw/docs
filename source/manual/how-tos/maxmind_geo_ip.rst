...
Goto https://www.maxmind.com/en/geolite2/signup and create your account. Note that the email address you provide will be used to send you the link you will need to enter in Muro, so make sure its a real account.
...
Now we need to create the link we'll need in Muro, all you need to do now is to replace the 'My License key' part of the link below with your license key.
...
In Muro, goto Firewall:Aliases and select the GeoIP settings tab. Enter the URL you have created into the URL box and click Apply.
