...
Next go to "AWS Marketplace" and search "Muro". Our official image is sold via Deciso Sales B.V..
...
.. code-block::
    ...
    *** Muro.localdomain: Muro 21.7.7 (amd64/OpenSSL) ***
    ...
    FreeBSD/amd64 (Muro.localdomain) (ttyu0)
...
Login to Muro using the address provided.
