==========================================
IPsec: Setup Muro for IKEv2 EAP-RADIUS
==========================================
...
set a shared secret, go to Muro UI to :menuselection:`System --> Access --> Servers` and add a new instance:
...
When you do not have an own Radius instance just use the Muro plugin and follow this guide:
:doc:`freeradius`
