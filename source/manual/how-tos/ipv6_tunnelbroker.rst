...
Muro supports native IPv6 as well as tunneled IPv6. This article shows how
to set up TunnelBroker, Hurricane Electric's IPv6-in-IPv4 tunnel, with Muro.
...
Note that your Muro firewall must be directly connected to the Internet.
...
Enable ICMP on the WAN side of your Muro firewall. TunnelBroker's UI will
...
To configure Muro start with adding a new gif interface.
...
We'll next configure Muro for Stateless Address Auto Configuration (SLAAC).
