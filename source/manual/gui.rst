...
This article explains the basics of the Muro Graphical User Interface or GUI
for short.
...
Logo & Link to Lobby
---------------------
Click on the Muro logo wherever you are in the interface and you will be
...
Many components within Muro use grid views to navigate through content, below is an example of a simple table view
