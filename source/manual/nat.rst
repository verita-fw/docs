...
In Muro, port forwarding can be set up by navigating to :menuselection:`Firewall --> NAT --> Port Forward`. Here, you will see
...
.. Note:
   ...
   In Muro, this feature is also used to implement transparent proxies. A connection needs to be forwarded to a
...
In Muro, one-to-one NAT can be set up by navigating to :menuselection:`Firewall --> NAT --> One-to-one`. Here, you will see an
