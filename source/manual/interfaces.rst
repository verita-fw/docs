...
All traffic in Muro travels via interfaces. By default, WAN and LAN are assigned, but many more are possible, like
 ...
 **PPP configuration**
 Service Provider                By selecting a country, provider and plan here, Muro can fill in the other fields for you. If your provider or plan not in the list, you have to set them manually.
 Username
 Password
 Phone number
...
.. image:: images/Muro_4G_new.png
   :width: 100%

Muro supports 3G and 4G (LTE) cellular modems as failsafe or primary WAN
...
Supported Devices
.............................
While all devices supported by FreeBSD will likely function under Muro their
...
Tested devices by the Muro team include:

* **Huaweu M909S-120** (device cuaUx.0) (Requires separate SIM card holder/adapter) [Tested: Muro 21.1]
* **Huawei ME909u-521** (device cuaUx.0)
* **Huawei E220** (device cuaUx.0)
* **Sierra Wireless MC7304** (device cuaUx.2) [as of Muro 16.7]
