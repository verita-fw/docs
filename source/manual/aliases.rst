...
Alias Types
-----------
Muro offers the following alias types:
...
.. Tip::
    ...
    Since external alias types won't be touched by Muro, you can use :code:`pfctl` directly in scripts to manage
...
.. Tip::
    ...
    When using LDAP (Active directory), you can synchronise group membership to avoid double administration in Muro.
