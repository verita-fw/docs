![alt text](https://opnsense.org/wp-content/themes/Muro/assets/img/opnsense.png "Logo Title Text 1")

# Muro documentation

Welcome to the Muro documentation & wiki.   
The purpose of this project is to provide Muro users with quality documentation.
...
Muro documentation is available under the 2-Clause BSD license:
